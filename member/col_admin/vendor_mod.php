...
<form name="form2" method="post" action="vendor_mod_cl.php" onsubmit="return check()">
<tr>
<td align="left" width="15%">
品牌名稱:
</td>
<td align="right">
<input type="text" name="kind" value="<?=$rs["kind"]?>">
</td>
</tr>
<tr>
<td align="left">
...
<td align="right">
<input type="text" name="authorized" value="<?=$rs["authorized"]?>">
</td>
</tr>
