...
$sql= "update carousel set link= '$link' , remarks='$remarks',pic_name = '$file' ,brand_name='$brand_name ' ,pro='$pro' ,kind='$kind' where id = '$id'";

}
else
$sql= "update carousel set link= '$link' , remarks='$remarks' ,brand_name='$brand_name' ,pro='$pro' ,kind='$kind' where id = '$id'";
