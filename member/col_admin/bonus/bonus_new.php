...
?>
<br>
<form action="bonus_new_cl.php" method="post" name="form1" id="form1" class="style2" enctype="multipart/form-data" onsubmit="return check()">
<table width="900dpi" height="200dpi" border="0" cellpadding="0" cellspacing="1">
<caption>新增產品</caption>
<tr>
<td align="right" >標題(x)：</td>
<td align="left" >
 <input type="text" name="titlex"  size=100 value=""> 
</td>
</tr>
<tr>
<td align="right" >原價：</td>
<td align="left" >$<input type="text" name="price"  size=10 value=""> 
/優惠價：
$<input type="text" name="price2"  size=10 value=""> 
</td>
</tr>
<tr>
