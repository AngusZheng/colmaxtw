...
<form name="form2" method="post" action="vendor_new_cl.php" onsubmit="return check()">
<tr>
...
$sql = "SELECT MAX(authorized) FROM vendor";
$conn=mysql_query($sql); 
$rs=mysql_fetch_array($conn);
?>
<input type="text" name="authorized" value="<?=$rs[0]*2?>">
</td>
</tr>
