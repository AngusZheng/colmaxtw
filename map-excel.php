<?php
$filename=date("Ymd")."經銷據點.xls";   // 建立檔名
...
<td width="10%" bgcolor="#FFFF00" align="center">店名</td>
<td width="40%"  bgcolor="#FFFF00" align="center">地址</td>
<td width="40%"  bgcolor="#FFFF00" align="center">電話</td>
<td width="40%"  bgcolor="#FFFF00" align="center">品牌</td>
