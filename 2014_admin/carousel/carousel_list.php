...
?>
<table width="700dpi" height="200dpi"  border="0" cellpadding="0" cellspacing="1" bgcolor="#000000">
<td width= "25%" bgcolor="#E0FFFF" align="center">照片</td>
<td width="40%" bgcolor="#E0FFFF"  align="center">品牌名</td>
...
mysql_select_db($sqlname,$db);
$sql = "SELECT * FROM carousel "; 
$sql.= " WHERE 1 and del = 0  order by sort_num desc limit $start,$per";
...
<td><img src="../../images/<?=$rs["id"].'.png'?>"></td>
<td><?=$rs["brand_name"]?></td>
